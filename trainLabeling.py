...
def labelPictures():
    if not os.path.isdir("./Santa"):
        os.makedirs("./Santa")
    if not os.path.isdir("./NoSanta"):
        os.makedirs("./NoSanta")
                ...
                for imgName in images:
                    try:
                        ...
                        if where.lower() == "stop":
                            ...
                            plt.close()
                            title = "./Santa/Santa_{:09d}.png".format(len(glob.glob('./Santa/*')))
                            ...
                            plt.close()
                            title = "./NoSanta/noSanta_{:09d}.png".format(len(glob.glob('./NoSanta/*')))
                            cv2.imwrite(title,img)
                            print "Saved at %s "%title
